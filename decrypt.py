def shift_letters(letters, shift):
    ...
    for letter in letters:
        ...
        # Apply the shift
        shifted_ascii = ascii_value - shift  # Subtracting the shift for decryption
...
# Decrypt the word
decrypted_word = shifted_word
for shift in shifts:
    decrypted_word = shift_letters(decrypted_word, -shift)  # Inverting shift for decryption
print("Decrypted Word:", convert_to_word(decrypted_word))
# Inside decrypt.py
